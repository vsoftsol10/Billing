...
const EWayBills = () => {
  ...
  const handleConnect = () => setShowConnectModal(true)          // ✅ only once
  ...
  return (
    <div className="relative flex bg-gray-50 min-h-screen overflow-hidden">
      ...
      {/* ✅ Modal outside <main>, at root level of the page */}
      {showConnectModal && (
        <EWayBillConnectModal onClose={() => setShowConnectModal(false)} />
      )}
