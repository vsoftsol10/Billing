...
const SAMPLE_DATA = [
  { id: '1019', type: 'Sales', lastSynced: '2026-03-24', records: '142', gstNo: '2026-01-14', status: 'Pending' },
  { id: '1022', type: 'Sales', lastSynced: '2026-03-24', records: '142', gstNo: '2026-01-14', status: 'Open' },
  { id: '1009', type: 'Sales', lastSynced: '2026-03-24', records: '142', gstNo: '2026-01-14', status: 'Open' },
  { id: '1009', type: 'Sales', lastSynced: '2026-03-24', records: '142', gstNo: '2026-01-14', status: 'Update' },
]
          ...
          <tbody className="divide-y divide-gray-200">
            {SAMPLE_DATA.map((row, index) => (
              <tr key={index} className="hover:bg-gray-50 transition-colors">
                ...
                <td className="px-6 py-4 text-sm text-gray-900">{row.lastSynced}</td>
                <td className="px-6 py-4 text-sm text-gray-900">{row.records}</td>
                <td className="px-6 py-4 text-sm text-gray-900">{row.gstNo}</td>
