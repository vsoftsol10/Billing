...
const handleSubmit = async () => {
  ...
  const unitMap = { No: "PCS", Pcs: "PCS", Kg: "KG", Ltr: "L", Mtr: "METER", Box: "BOX", Set: "OTHER" };

  try {
    const res = await createProduct({
      businessId,
      name:          form.name,
      categoryId:    null,                      // ✅ remove form.category for now
      unit:          unitMap[form.units] || "PCS",
      sellingPrice:  form.sellingPrice,
      costPrice:     form.purchasePrice  || null,
      hsnCode:       form.hsnSac         || null,
      description:   form.description    || null,
      sku:           form.barcode        || null,
      lowStockAlert: form.lowStockAlert  || 10,
    });
