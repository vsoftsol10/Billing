            ...
            {!forgotSubmitted ? (
              <>
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  <button
                    onClick={closeModal}
                    className="text-gray-300 hover:text-gray-500 transition-colors mt-1 ml-4"
                  >
                ...
                <form onSubmit={handleForgotSubmit} className="space-y-4">
                  ...
                  <button
                    ...
                    className="w-full bg-amber-400 hover:bg-amber-500 text-gray-900 font-display font-semibold text-sm py-3 rounded-xl disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2 transition-all duration-200 hover:shadow-md hover:shadow-amber-400/30 hover:-translate-y-0.5 active:translate-y-0"
                  >
                    {forgotLoading ? (
                      <>
                        <svg className="spinner w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5">
              ...
              <div className="success-pop text-center py-2">
                ...
                <button
                  onClick={closeModal}
                  className="w-full bg-amber-400 hover:bg-amber-500 text-gray-900 font-display font-semibold text-sm py-3 rounded-xl flex items-center justify-center transition-all duration-200 hover:shadow-md hover:shadow-amber-400/30"
                >
                  Back to Login
                </button>
              </div>
