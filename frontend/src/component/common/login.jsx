      ...
      <div className="hidden md:flex flex-col justify-between relative w-[46%] bg-amber-400 p-10 overflow-hidden rounded-tr-[40%] rounded-br-3xl">
        ...
        <div className="relative z-10">
          <div className="flex items-center gap-2">
            ...
            <span className="font-display font-700 text-gray-900 text-lg font-bold tracking-tight">SwiftPOS</span>
          </div>
        </div>
        ...
        <div className="relative z-10 text-center">
          ...
          <p className="text-gray-800 text-sm leading-relaxed max-w-xs mx-auto">
            Everything you need to handle invoices, track payments, and manage your billing efficiently in one place.
          </p>

          {/* Feature pills */}
          <div className="mt-8 flex flex-col gap-3 ">
            {[
              { icon: '⚡', text: 'Fast Invoice Generation' },
              { icon: '📊', text: 'Real-time Sales Tracking' },
              { icon: '🔒', text: 'Secure & Reliable' },
            ].map((f) => (
              <div key={f.text} className="flex items-center justify-center gap-3 bg-white bg-opacity-40 rounded-xl px-4 py-2.5 backdrop-blur-sm">
      ...
      <div className="flex-1 bg-white flex items-center justify-center p-10">
        <div className="w-full max-w-sm">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <div className="slide-up slide-up-2">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="input-field w-full pl-10 pr-4 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm text-gray-900 placeholder-gray-400"
                />
              </div>
            </div>
            ...
            <div className="slide-up slide-up-3">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  required
                  className="input-field w-full pl-10 pr-11 py-3 rounded-xl border border-gray-200 bg-gray-50 text-sm text-gray-900 placeholder-gray-400"
                />
                <button
                  type="button"
              ...
              <div className="slide-up slide-up-4 text-right mt-1.5">
            ...
            <div className="slide-up slide-up-5 pt-1">
              <button
                type="submit"
                disabled={isLoading}
                className="btn-login w-full bg-amber-400 text-gray-900 font-display font-semibold text-sm py-3.5 rounded-xl disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
              >
                {isLoading ? (
                  <>
          ...
          <p className="slide-up slide-up-6 text-center text-sm text-gray-500 mt-6">
            ...
            <a href="/register" className="text-amber-500 hover:text-amber-600 font-semibold transition-colors">
              Sign up
            </a>
          </p>
        </div>
